...
export default function PrivacyPolicyGorillaLawFirm() {
  return (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-3xl font-bold">Privacy Policy for Gorilla Law Firm</h1>
              </div>

              <div className="prose prose-invert max-w-none">
                <div className="bg-muted/20 rounded-lg p-6 mb-6">
                  <h2 className="text-xl font-semibold mb-4">Davis W. Smith P.C. (The Gorilla Law Firm)</h2>
                ...
                <h2 className="text-xl font-semibold mt-8 mb-4">3. CONFIDENTIALITY AND ATTORNEY-CLIENT PRIVILEGE</h2>
                ...
                <h2 className="text-xl font-semibold mt-8 mb-4">8. MOBILE APPLICATION SPECIFIC</h2>
                ...
                <h2 className="text-xl font-semibold mt-8 mb-4">12. LEGAL BASIS FOR PROCESSING</h2>
