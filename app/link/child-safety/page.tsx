          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold">Link Child Safety Standards</h1>
              ...
              <div className="prose prose-invert max-w-none">
                <div className="bg-yellow-900/20 border border-yellow-900/50 rounded-md p-4 mb-6 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-400/80 text-sm mt-1">
                      Link is designed for adults 18+ only. We have implemented strict measures to ensure our platform
                      remains safe and appropriate for our adult users.
                    </p>
                  </div>
                </div>

                <h2 className="text-xl font-semibold mt-6 mb-4">Link's Minimal Functionality Approach</h2>
                <p>
                  Link is fundamentally different from most dating and social apps. We've intentionally designed our
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Link does not allow users to upload, share, or exchange photos or videos of any kind.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <p>
                  Despite Link's minimal functionality that inherently prevents many safety concerns, we are fully
                ...
                <ul className="list-disc pl-6 my-4 space-y-2">
                  <li>
                    We strictly prohibit the use of Link by individuals under the age of 18, enforced through our phone
                    verification system
                  </li>
                ...
                <p>Link's design inherently prevents the sharing of any content, including CSAM:</p>
                <ul className="list-disc pl-6 my-4 space-y-2">
                  <li>
                ...
                <p>Link is designed to comply with all applicable child safety laws and regulations:</p>
                <ul className="list-disc pl-6 my-4 space-y-2">
                ...
                <p>
                  While Link's minimal functionality approach inherently prevents many of the risks associated with
