          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="space-y-4">
                  <div className="border border-border rounded-lg p-4">
                    ...
                    <p className="text-muted-foreground mt-2">
                      Likeback only stores your name and phone number in our secure database. We prioritize your privacy and
                ...
                <p className="mt-6">
                  Thank you for choosing Likeback. We're committed to helping you build meaningful connections through our
