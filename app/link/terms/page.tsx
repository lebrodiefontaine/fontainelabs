          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <p>
                  Welcome to Likeback. These Terms of Service ("Terms") govern your use of the Likeback mobile application (the
                ...
                <p>
                  Likeback operates on a double opt-in basis, meaning that both parties must express interest in each other
